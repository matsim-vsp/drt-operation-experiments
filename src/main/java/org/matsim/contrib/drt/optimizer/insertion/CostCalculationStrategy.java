 ...
 * With some local change values to reproduce the result from a previous jar file.
 */
public interface CostCalculationStrategy {
	...
	class DiscourageSoftConstraintViolations implements CostCalculationStrategy {
		...
		// Each of the penalty values below are increased 1000 times
		static final double MAX_WAIT_TIME_VIOLATION_PENALTY = 1000;// 1 second of penalty per 1 second of late departure
		static final double MAX_TRAVEL_TIME_VIOLATION_PENALTY = 10000;// 10 seconds of penalty per 1 second of late arrival
