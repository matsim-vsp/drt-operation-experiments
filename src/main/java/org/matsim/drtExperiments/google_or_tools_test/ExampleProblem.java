package org.matsim.drtExperiments.google_or_tools_test;
...
public class ExampleProblem {
    private static final Logger logger = LogManager.getLogger(ExampleProblem.class);
    ...
    public static void main(String[] args) {
        ...
        // depot idx
        int depot = 0;
        // tasks {from station idx, to station idx}
